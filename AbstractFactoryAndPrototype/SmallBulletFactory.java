...
public class SmallBulletFactory extends AbstractFactory {
	public Small_Slow_Bullet createSlowBullet(boolean Friendly, int posX, int posY, double[] vel) {
	...
	public Small_Fast_Bullet createFastBullet(boolean Friendly, int posX, int posY, double[] vel) {
