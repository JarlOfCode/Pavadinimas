...
public class BigBulletFactory extends AbstractFactory {
	public Big_Slow_Bullet createSlowBullet(boolean Friendly, int posX, int posY, double[] vel) {
		Big_Slow_Bullet bsb = new Big_Slow_Bullet(Friendly, posX, posY, vel);
		return bsb;
	}
	
	public Big_Fast_Bullet createFastBullet(boolean Friendly, int posX, int posY, double[] vel) {
